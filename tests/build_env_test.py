...
def test_build_env_docker_build_with_docker_tool(mocker):
    '''
    Tests that passing --docker_tool argument with docker_build argument works correctly.
    '''
    dirTracker = helpers.DirTracker()
    mocker.patch(
        'os.getcwd',
    ...
    arg_strings = ["build", build_env.COMMAND, "--docker_build",
                   "--docker_tool", "podman", "my-env.yaml"]
    open_ce._main(arg_strings)
